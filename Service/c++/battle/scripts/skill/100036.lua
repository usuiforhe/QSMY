g_skill_100036 =
{
	...
	is_trigger = function(frames, level, unit, event_id, event_args)
		local trigger_rate = g_skill_100036.trigger_rate;
		local result =
		{
		    trigger = false,
		    coactors = {},
	...
	--	local buff = g_skill_100010.buffs[1];
		...
		local attack_parameter = g_skill_100036.attack_parameter;
		local skill_lv = level;
		local grow =  g_skill_100036.grow;
		local buff_trigger_rate = g_skill_100036.buff_trigger_rate;
