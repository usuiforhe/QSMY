g_skill_300008 =
{
	...
	is_trigger = function(frames, level, unit, event_id, event_args)
		local trigger_rate = g_skill_300008.trigger_rate;
		local result =
		{
		    trigger = false,
		    coactors = {},
	...
	effect = function(frames, level, unit , attacker)	
		...
		local attack_parameter = g_skill_300008.attack_parameter;
		local skill_lv = level;
		local grow =  g_skill_300008.grow;
		local buff_trigger_rate = g_skill_300008.buff_trigger_rate;
