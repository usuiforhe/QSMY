g_skill_100048 =
{
	...
	is_trigger = function(frames, level, unit, event_id, event_args)
		local trigger_rate = g_skill_100048.trigger_rate;
		local result =
		{
		    trigger = false,
		    coactors = {},
	...
	--	local buff = g_skill_100048.buffs[1];		
		local attack_parameter = g_skill_100048.attack_parameter;
		local skill_lv = level;
		local grow =  g_skill_100048.grow;
				
		local buff_trigger_rate = g_skill_100048.buff_trigger_rate;
