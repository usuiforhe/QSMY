...
{
	-- 武罗		
	--对三行目标造成 174% 伤害		修罗拳·爆	15%概率技能变为全体攻击
	-- 名称
		name = '武罗',
	-- 优先级
		priority = 1 ,
	...
	is_trigger = function(frames, level, unit, event_id, event_args)
		local trigger_rate = g_skill_100016.trigger_rate;
		local result =
		{
		    trigger = false,
		    coactors = {},
	...
	--	local buff = g_skill_100016.buffs[1];		
		local attack_parameter = g_skill_100016.attack_parameter;
		local skill_lv = level;
		local grow =  g_skill_100016.grow;
				
		local buff_trigger_rate = g_skill_100016.buff_trigger_rate;
