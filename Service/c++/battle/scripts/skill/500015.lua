g_skill_500015 =
{
	...
	is_trigger = function(frames, level, unit, event_id, event_args)
		local trigger_rate = g_skill_500015.trigger_rate;
		local result =
		{
		    trigger = false,
		    coactors = {},
	...
	effect = function(frames, level, unit , attacker)	
		local buff = g_skill_500015.buffs[1];
		...
		local attack_parameter = g_skill_500015.attack_parameter;
		local skill_lv = level;
		local grow =  g_skill_500015.grow;
		local buff_trigger_rate = g_skill_500015.buff_trigger_rate;
