...
{    
	...
	on_add_layer = function(owner, source, argument)
		owner.attack =owner.attack - math.floor(owner.base_attack * argument.arg.attack/100);
	end,
	...
	on_exit = function(owner, source, argument)
		owner.attack =owner.attack + math.floor(owner.base_attack * argument.arg.attack/100) * argument.layer;
	end
};
