...
{    
	...
	on_add = function(owner, source, argument)
		owner.state.can_action = false;
		owner.state.can_dodge = false;
		owner.state.can_block = false;
	end,
	...
	on_exit = function(owner, source, argument)
		owner.state.can_action = true;
		owner.state.can_dodge = true;
		owner.state.can_block = true;
	end
};
