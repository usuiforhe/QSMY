...
#ifndef __QSMY__GuildBossRankCellContribution__
#define __QSMY__GuildBossRankCellContribution__
...
class GuildBossRankCellContribution 
	:public GuildBossRankCell
	,public cocos2d::extension::CCBMemberVariableAssigner
{

public:
	GuildBossRankCellContribution();
	~GuildBossRankCellContribution();
